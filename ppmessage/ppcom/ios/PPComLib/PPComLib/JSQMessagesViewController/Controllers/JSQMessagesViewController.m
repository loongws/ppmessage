...
+ (UINib *)nib
{
    NSString *path = [[NSBundle mainBundle] pathForResource:@"PPComLib" ofType:@"bundle"];
    NSBundle *bundle = [NSBundle bundleWithPath:path];
    return [UINib nibWithNibName:@"JSQMessagesViewController" bundle:bundle];
}
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"self.senderId:%@, messageSenderId:%@", messageSenderId, self.senderId);
