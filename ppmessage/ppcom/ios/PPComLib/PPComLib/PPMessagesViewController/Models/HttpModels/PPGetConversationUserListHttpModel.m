...
- (void)usersWithConversationUUID:(NSString *)conversationUUID
    ...
    [self.client.api getConversationUserList:params completionHandler:^(NSDictionary *response, NSError *error) {
        ...
        if (response && [response[@"error_code"] integerValue] == 0) {
            ...
            [array enumerateObjectsUsingBlock:^(NSDictionary *obj, NSUInteger idx, BOOL * _Nonnull stop) {
                PPUser *user = [[PPUser alloc] initWithClient:self.client uuid:obj[@"uuid"] fullName:obj[@"user_fullname"] avatarId:PPSafeString(PPFileUrl(obj[@"user_icon"]))];
