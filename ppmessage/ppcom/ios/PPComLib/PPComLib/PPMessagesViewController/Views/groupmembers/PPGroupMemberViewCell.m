...
- (void)setGroupMember:(PPUser *)groupMember {
    ...
    if (_groupMember) {
        [self.memberAvatarImageView loadWithUrl:_groupMember.avatarUrl placeHolderImage:PPDefaultAvatarImage() completionHandler:nil];
        self.memberNameLabel.text = _groupMember.fullName;
    }
}
